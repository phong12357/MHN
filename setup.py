...
setup(
	...
	classifiers=['Development Status :: 4 - Beta','License :: OSI Approved :: MIT License','Programming Language :: Python3','Topic :: Software Development :: Libraries :: Python3 Modules'], # Get strings from http://pypi.python.org/pypi?%3Aaction=list_classifiers
